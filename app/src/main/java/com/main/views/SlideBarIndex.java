...
import com.main.utils.ViewUtils;

/**
 * 字母列表
 */

public class SlideBarIndex extends View {
    ...
    // 构造方法
    public SlideBarIndex(Context context) {
        super(context);
        this.textSize = (float) ViewUtils.dip2px(context, (float) 14.0);
    }

    public SlideBarIndex(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.textSize = (float) ViewUtils.dip2px(context, (float) 14.0);
    }
...
//            canvas.drawColor(Color.parseColor("#55000000"));
        ...
        for (int i = 0; i < letters.length; i++) {
            ...
            if (i == choose) {
                ...
                paint.setTextSize((float) ViewUtils.dip2px(getContext(), (float) 20.0));
            }
    ...
    public interface OnTouchLetterChangeListenner {
        void onTouchLetterChange(boolean isTouched, String num);
    }
