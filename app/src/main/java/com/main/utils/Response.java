...
public final class Response<T> {
    ...
    public static <T> Response<T> success(boolean isFromCache, T body, okhttp3.Call rawCall, okhttp3.Response rawResponse) {
    ...
    public static <T> Response<T> error(boolean isFromCache, okhttp3.Call rawCall, okhttp3.Response rawResponse, Throwable throwable) {
        Response<T> response = new Response<>();
        response.setFromCache(isFromCache);
        response.setRawCall(rawCall);
        response.setRawResponse(rawResponse);
